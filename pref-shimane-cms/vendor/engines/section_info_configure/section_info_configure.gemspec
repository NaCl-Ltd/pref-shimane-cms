...
require "section_info_configure/version"

# Describe your gem and declare its dependencies:
Gem::Specification.new do |s|
  s.name        = "section_info_configure"
  s.version     = SectionInfoConfigure::VERSION
  s.authors     = ["Network Applied Communication Laboratory Ltd."]
  s.email       = ["webmaster@netlab.jp"]
  s.homepage    = "http://www.netlab.jp/"
  s.summary     = "Section's Info Configure Engine"
  s.description = "section_info_configure provide managing section's information"
