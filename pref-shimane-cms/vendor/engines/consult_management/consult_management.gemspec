...
require "consult_management/version"

# Describe your gem and declare its dependencies:
Gem::Specification.new do |s|
  s.name        = "consult_management"
  s.version     = ConsultManagement::VERSION
  s.authors     = ["Network Applied Communication Laboratory Ltd."]
  s.email       = ["webmaster@netlab.jp"]
  s.homepage    = "http://www.netlab.jp/"
  s.summary     = "Consult Management Engine"
  s.description = "consult_management provide consult page"
