...
require "site_design/version"

# Describe your gem and declare its dependencies:
Gem::Specification.new do |s|
  s.name        = "site_design"
  s.version     = SiteDesign::VERSION
  s.authors     = ["Network Applied Communication Laboratory Ltd."]
  s.email       = ["webmaster@netlab.jp"]
  s.homepage    = "http://www.netlab.jp/"
  s.summary     = "Site Design Engine."
  s.description = "You can change pref-shimane-cms design(public side) to custom this engine."
