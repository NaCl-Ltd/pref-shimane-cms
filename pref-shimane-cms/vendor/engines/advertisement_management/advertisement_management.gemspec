...
require "advertisement_management/version"

# Describe your gem and declare its dependencies:
Gem::Specification.new do |s|
  s.name        = "advertisement_management"
  s.version     = AdvertisementManagement::VERSION
  s.authors     = ["Network Applied Communication Laboratory Ltd."]
  s.email       = ["webmaster@netlab.jp"]
  s.homepage    = "http://www.netlab.jp/"
  s.summary     = "Advertisement Management Engine."
  s.description = "advertisement_management manages the advertising to be output to site"
